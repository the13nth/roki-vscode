...
export class ApiConfigManager {
     ...
     */
    async getProjectApiConfig(): Promise<ApiConfiguration | null> {
        try {
     ...
     */
    async getApiKeySelection(): Promise<ApiKeySelection | null> {
        try {
            if (!this.projectDetector.detectAiProject()) {
                throw new Error('No AI project detected');
            }
     ...
     */
    async setApiKeySelection(usePersonalApiKey: boolean): Promise<boolean> {
        try {
            if (!this.projectDetector.detectAiProject()) {
                throw new Error('No AI project detected');
            }
     ...
     */
    async testApiConfiguration(): Promise<{ success: boolean; message: string }> {
        try {
            if (!this.projectDetector.detectAiProject()) {
                throw new Error('No AI project detected');
            }
     ...
     */
    async showApiConfigStatus(): Promise<void> {
        try {
     ...
     */
    async showApiKeySelectionDialog(): Promise<void> {
        try {
            const selection = await this.getApiKeySelection();
     ...
     */
    private async testAndShowResult(): Promise<void> {
